            ...
            {data.map((evento, index) => (
                <div key={index} className="timeline-item">
                    ...
                    <div className="timeline-content">
                        ...
                        {/* Solo mostramos el autor si el tipo de evento es 'Cierre de Expediente' */}
                        {evento.autorCompleto && evento.tipoEvento === 'Cierre de Expediente' && (
                                <p className="event-author">
                                    Realizado por: <strong>{evento.autorCompleto}</strong>
                        </p>
                        )}
                    </div>
                </div>
