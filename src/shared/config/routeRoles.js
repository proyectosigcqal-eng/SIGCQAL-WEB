...
//   '/correspondencia/contestacion':       ['Administrador', 'Administrador Correspondencia'],
//   '/correspondencia/contestacion-oficio':['Administrador', 'Administrador Correspondencia'],
//   '/correspondencia/contestacion-correspondencia': ['Administrador', 'Administrador Correspondencia'],
//   '/correspondencia/nuevo-oficio-contestacion':    ['Administrador', 'Administrador Correspondencia'],
//   '/correspondencia/seguimiento':        ['Administrador', 'Administrador Correspondencia'],
//   '/correspondencia/bandeja':            ['Administrador', 'Administrador Correspondencia', 'Gestor de Correspondencia'],
//   '/correspondencia/pendiente-revision-area':      ['Administrador', 'Gestor de Correspondencia'],
//   '/correspondencia/acuses-correspondencia':       ['Administrador', 'Gestor de Correspondencia'],
//   '/correspondencia/acuses-oficio-por-area':       ['Administrador', 'Gestor de Correspondencia'],
//   '/correspondencia/asignar-area':       ['Administrador', 'Administrador Correspondencia'],
//   '/correspondencia/asignar-area-oficio':['Administrador', 'Administrador Correspondencia'],
//   '/correspondencia/bitacora':           ['Administrador', 'Administrador Correspondencia'],
//   '/correspondencia/lista-memorandums-revision':   ['Administrador', 'Gestor de Correspondencia'],
//   '/correspondencia/lista-oficios-revision':       ['Administrador', 'Gestor de Correspondencia'],
//   '/correspondencia/memorandums-por-area':         ['Administrador', 'Gestor de Correspondencia'],
//   '/correspondencia/oficios-por-area':             ['Administrador', 'Gestor de Correspondencia'],
