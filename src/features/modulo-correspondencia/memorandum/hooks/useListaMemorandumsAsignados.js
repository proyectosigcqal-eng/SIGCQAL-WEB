...
export const useListaMemorandumsAsignados = () => {
...
const cargar = async () => {
  ...
  try {
    ...
    const url = idArea === TODAS_LAS_AREAS
      ? `${API_BASE_URL}/memorandums/asignados/todos`   // ← nuevo endpoint para admin
  ...
  return { memorandums, loading, error, recargar: cargar, areaForzada: idArea };
};