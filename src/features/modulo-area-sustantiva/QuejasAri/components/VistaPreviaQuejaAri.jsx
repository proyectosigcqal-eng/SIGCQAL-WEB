    ...
    <div className="panel-vista-previa" id="queja-ari-pdf-content">
      ...
      <div className="hoja-membretada-papel" style={estiloHojaFondo}>
        <div className="membrete-contenido">
          <div>
            ...
            <div className="membrete-meta-info" style={{ textAlign: 'right', marginBottom: '15px' }}>
              ...
              <p className="meta-folio" style={{  margin: '0 0 8px 0' }}>
                <strong style={{ fontSize: '16px' }}>Folio:(Folio_gobierno)</strong>
              </p>
            ...
            <div className="cuerpo-memorandum">
              ...
              <div className="texto-contenido">
                ...
                <div className="seccion-queja" style={{ marginBottom: '15px' }}>
                  ...
                  <p style={{ textAlign: 'justify' }}>
                    1.	Solicitud para la prestación del servicio de asesoría y consulta, recibida el 12 de mayo de 2025(fechaSolicitud), signada por Urbano Pérez López(NOMBREASESOR), con Registro Federal de Contribuyentes RURG671021AT5(rfc_asesor) con motivo de actos y omisiones de la Subirección de Ingresos, de la Secretaría de Finanzas del Estado de Zacatecas, mediante la cual en su parte medular señala lo siguiente:
                  </p>

                  <p style={{ textAlign: 'justify' }}>
                    “Se presenta a las instalaciones de esta Comisión, el contribuyente Luis Miguel Castro Camacho(NOMBREREPRESENTANTE), {actosOmisiones || <span className="placeholder-muted">[Sin motivo de la visita]</span>}.”
                  </p>   
                  ...
                  <p style={{ textAlign: 'justify' }}>
                   ...
                   <p style={{ textAlign: 'justify' }}>
                    a)	Credencial para votar, expedida por el Instituto Nacional Electoral {instituto || <span className="placeholder-muted">[Instituto]</span>}, a nombre de Griselda Ruiz Reyes(NOMBRECONTRIBUYENTE), con número de identificación 1207062611312(IDENTIFICACIONCONTRIBUYENTE)
                  </p>               
          ...
          {/* Un indicador visual opcional por si necesitas foliado en pantalla */}
      ...
      <div className="hoja-membretada-papel" style={estiloHojaFondo}>
        <div className="membrete-contenido">
          <div>
            <div className="cuerpo-memorandum" style={{ marginTop: '10px' }}>
              {/* TABLA DE ACTOS Y OMISIONES */}
                <table style={{
                  width: '100%',
                  borderCollapse: 'collapse',
                  border: '3px double #000000', // Simula el borde doble exterior
                  fontFamily: 'sans-serif',
                  fontSize: '14px'
                }}>
                  <thead>
                    <tr style={{ backgroundColor: '#e2e8f0' }}> {/* Fondo gris del encabezado */}
                      <th style={{
        ...
        <p style={{ textAlign: 'justify', marginBottom: '9px' }}>
          <strong>V. Pruebas.</strong> Se tienen por ofreciidas y admitidas como prueba las documentales anexadas a la solicitud de servicio, por parte de la contribuyente. 
        </p>

        <p style={{ textAlign: 'justify', marginBottom: '9px' }}> {/* Un margen ligeramente mayor antes del siguiente bloque si se desea */}
