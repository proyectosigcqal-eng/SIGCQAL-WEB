import { usePlazoPrevencion } from '../hooks/usePlazoPrevencion';
...
export const SemaforoPlazo = ({ folio }) => {
  const { plazo, cargando, error } = usePlazoPrevencion(folio);
